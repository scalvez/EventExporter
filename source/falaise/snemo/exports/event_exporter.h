  ...
  namespace reconstruction {
    ...
    namespace exports {
        ...
        enum export_bit_type
          {
            ...
            EXPORT_PARTICLE_TRACKS        = datatools::bit_mask::bit08,
            ...
            | EXPORT_PARTICLE_TRACKS,

            // EXPORT_LAST = EXPORT_TRACKER_TRAJECTORIES,
            EXPORT_LAST = EXPORT_PARTICLE_TRACKS,
          };
      ...
      protected:
        ...
        int _export_particle_tracks (const datatools::things &,
                                     snemo::reconstruction::exports::export_event &);
