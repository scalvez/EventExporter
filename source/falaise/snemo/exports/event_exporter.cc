  ...
  namespace reconstruction {
    ...
    namespace exports {
      ...
      void event_exporter::initialize (const datatools::properties & setup_)
      {
        ...
        if (setup_.has_flag ("export.particle_tracks"))
          {
            set_exported (sre::event_exporter::EXPORT_PARTICLE_TRACKS);
          }
      ...
      void event_exporter::_set_default_bank_labels ()
      {
        ...
        _bank_labels_[sdm::data_info::PARTICLE_TRACK_DATA_LABEL]    = sdm::data_info::default_particle_track_data_label();
        return;
      }
      ...
      std::string event_exporter::get_export_bit_label (unsigned int bit_)
      {
        ...
        if (bit_ == event_exporter::EXPORT_PARTICLE_TRACKS) return "particle_tracks";
        return "";
      }
                               ...
                               sre::export_event & ee_)
      {
        ...
        if (is_exported (sre::event_exporter::EXPORT_PARTICLE_TRACKS))
          {
            _export_particle_tracks (er_, ee_);
          }
