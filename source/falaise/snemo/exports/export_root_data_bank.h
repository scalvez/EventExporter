 ...
 * Description:
 *
 *   Module for exporting SuperNEMO data banks to ROOT file(s)
 *
 * History:
 *
 */

#ifndef EXPORTS_EXPORT_ROOT_DATA_BANK_H
#define EXPORTS_EXPORT_ROOT_DATA_BANK_H 1
...
namespace snemo {
    ...
    namespace exports {
      ...
      public:
        ...
        /// Default constructor
        export_root_data_bank ();

        /// Destructor
        virtual ~export_root_data_bank ();
...
#endif // SNRECONSTRUCTION_EXPORTS_EXPORT_ROOT_DATA_BANK_H

// end of export_root_data_bank.h
